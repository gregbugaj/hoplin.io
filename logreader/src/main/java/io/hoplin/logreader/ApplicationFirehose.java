...
/**
 * Connects to RabbitMQ log exchanges and logs all received messages to the console. This requires
 * that the fire hose features it turned on
 *
 * <pre>
...
public class ApplicationFirehose {
  ...
  private static void handle(final OptionSet options, final Environment env,
