...
/**
 * Basic client that wraps most {@link Channel} operations, and provides number of convenience
 * methods.
 */
public interface RabbitMQClient {
   ...
   * protocol exception, which closes the channel. Invocations of Channel#request will eventually
   * block if a resource-driven alarm is in effect.
   *
   ...
   */
  void exchangeDeclare(final String exchange, final String type, boolean durable,
      boolean autoDelete);

  /**
   * Declare an exchange.
   *
   * @see com.rabbitmq.client.Channel#exchangeDeclare(String, String, boolean  final Map<String,
   * Object>)
   */
