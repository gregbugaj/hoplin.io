...
public interface AckStrategy extends ThrowingBiConsumer<com.rabbitmq.client.Channel, java.lang.Long, Exception>
{
     ...
     */
    static boolean acknowledge(final Channel channel, final MessageContext context, final AckStrategy ack)
    {
    ...
    class Util
    {
        ...
        public static boolean acknowledge(final Channel channel, final MessageContext context, final AckStrategy ack)
        {
            ...
            try
            {
                ...
                log.info("Acknowledging  [strategy, messageId, deliveryTag] : {}, {}, {}", ack, messageId, deliveryTag);
