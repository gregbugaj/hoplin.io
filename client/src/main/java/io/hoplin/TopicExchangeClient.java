...
public class TopicExchangeClient extends AbstractExchangeClient
{
     ...
     * @return new TopicExchangeClient
     */
    public static ExchangeClient create(final RabbitMQOptions options, final String exchangeName, final String queue, final String bindingKey)
    {
        Objects.requireNonNull(options);
        return new TopicExchangeClient(options, createSensibleBindings(exchangeName, queue, bindingKey));
    }
